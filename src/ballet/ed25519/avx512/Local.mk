$(call add-hdrs,fd_r43x6.h fd_r43x6_inl.h fd_r43x6_ge.h fd_r51x8.h fd_ed25519_x8.h)
ifdef FD_HAS_AVX512
$(call add-objs,fd_r43x6 fd_r43x6_ge fd_ed25519_x8,fd_ballet)
$(call make-unit-test,test_r43x6,test_r43x6,fd_ballet fd_util)
$(call run-unit-test,test_r43x6)
$(call make-unit-test,test_ed25519_x8,test_ed25519_x8,fd_ballet fd_util)
$(call run-unit-test,test_ed25519_x8)
